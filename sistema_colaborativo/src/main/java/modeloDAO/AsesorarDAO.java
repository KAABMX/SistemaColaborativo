...
public class AsesorarDAO {
    ...
    public void actualizar(Asesorar asesorar) {
        ...
        /**
     * Regresa la lista de todos los Asesorarias en la base de datos
     * @return la lista que contiene a todos los Asesorarias de la base de datos
     */
    public List<Asesorar> getAsesorarias(){
