            ...
            <div class="w3-row-padding">
                ...
                <div class="w3-twothird">
                    ...
                    <div class="w3-container w3-card w3-white w3-margin-bottom">
                        <h2></h2>
                        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Mas informacion:</h2>
                        <div class="w3-container">
                            <h5 class="w3-opacity"><b>Ultimo nivel academico</b></h5>
                            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>${nivel}<span class="w3-tag w3-teal w3-round"></span></h6>
                            <hr>
                        </div>
                        <div class="w3-container">
                            <h5 class="w3-opacity"><b>Intereses Academicos</b></h5>
                            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>${intereses}<span class="w3-tag w3-teal w3-round"></span></h6>
                            <hr>
                        </div>
                    </div>
                    ...
                    <div class="w3-container w3-card w3-white w3-margin-bottom">
                        ...
                        <p> <a href="${pageContext.request.contextPath}/alumno/actualizaalumno">Actualiza tu perfil</a></p> 
